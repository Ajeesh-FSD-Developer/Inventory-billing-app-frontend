...
export default function Customer() {
  ...
  useEffect(() => {
    const fetching = async () => {
      ...
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/customers/getallcustomer/${currentUser._id}`,
        {
          headers:{
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const t=localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/customers/addcustomer/${currentUser._id}  `,
        {
          method: "POST",
  ...
  const handleDelete = async (id) => {
    try {
      const t=localStorage.getItem("access_token");
      const res = await fetch(`https://inventory-billing-app-backend-roes.onrender.com/api/customers/deletecustomer/${id}`, {
        method: "DELETE",
        Authorization: `Bearer ${t}`,
      });
      const data = await res.json();
