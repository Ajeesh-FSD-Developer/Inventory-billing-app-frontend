...
export default function Editcustomer() {
  ...
  useEffect(() => {
    const fetching = async () => {
      ...
      const res = await fetch(`https://inventory-billing-app-backend-roes.onrender.com/api/customers/editcustomer/${id}`,{
        headers:{
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      const t=localStorage.getItem("access_token");
      const res = await fetch(`https://inventory-billing-app-backend-roes.onrender.com/api/customers/updatecustomer/${id}`, {
        method: "POST",
        headers: {
