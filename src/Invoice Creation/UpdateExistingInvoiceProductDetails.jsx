...
export const UpdateExistingInvoiceProductDetails = () => {
    ...
    const fetching = async () => {
      try {
        ...
        const res = await fetch(
          `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/updateproductquantityinexisitinginvoice/${id}?productid=${productid}`,{
            headers:{
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      const t=localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/updateproductsdoneinexistinginvoice/${id}?productid=${productid}`,
        {
          method: "POST",
          headers: {
