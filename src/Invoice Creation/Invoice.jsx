...
export default function Invoice() {
  ...
  const handlesearchProductID = async () => {
    try {
      ...
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/products/getproduct/${currentproduct.productID}/${currentUser._id}`,
        {
          headers: {
  ...
  const handlesearchCustomerID = async () => {
    try {
      const t = localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/customers/getcustomer/${currentCustomer.customerID}/${currentUser._id}`,
        {
          headers: {
            Authorization: `Bearer ${t}`,
          },
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const t = localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/createInvoice/${currentUser._id}`,
        {
          method: "POST",
          headers: {
