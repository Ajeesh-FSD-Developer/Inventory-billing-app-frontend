...
export const UpdateInvoice = () => {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/updateexistinginvoice/${paramsid}`,
        {
          method: "POST",
          headers: {
  ...
  const handledelete = async (delete_id) => {
    ...
    try {
      const t=localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/deleteproductfrominvoice/${paramsid}?delete_id=${delete_id}`,
        {
          method: "DELETE",
          headers:{
            Authorization: `Bearer ${t}`,
  ...
  useEffect(() => {
    const fetching = async () => {
      try {
        const t=localStorage.getItem("access_token");
        const res = await fetch(`https://inventory-billing-app-backend-roes.onrender.com/api/invoices/updateinvoice/${paramsid}`,{
          headers:{
            Authorization: `Bearer ${t}`,
          }
        });
