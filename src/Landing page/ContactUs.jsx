  ...
  return (
    <>
        ...
        <div className="conatctus flex flex-col mt-10 " id="contact-us">
            ...
            <span className="text-center text-white font-semibold mt-5">Address: 123 Main Street, Chennai<br /> Cityville, Chennai-600028</span>
            <span className="text-center text-white font-semibold mt-5">+91 99999-88888</span>
            <span className="text-center text-white font-semibold mt-5">@ copyright all rights reserved</span>
        </div>
