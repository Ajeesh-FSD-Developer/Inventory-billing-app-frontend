...
export const AddProductToInvoiceInUpdatePage = () => {
  ...
  useEffect(() => {
    const fetching = async () => {
      try {
        const t=localStorage.getItem("access_token");
        const res = await fetch(
          `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/getproductsforexistinginvoice/${id}`,
          {
            headers:{
              Authorization: `Bearer ${t}`,
            }
  ...
  const handleupdateaddproduct = async (e) => {
    ...
    try {
      ...
      const t=localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/invoices/addproductstoexistinginvoice/${id}`,
        {
          method: "POST",
