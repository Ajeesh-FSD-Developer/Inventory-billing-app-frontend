...
export default function AddProduct() {
    ...
    const fetching = async () => {
      try {
        ...
        const res = await fetch(
          `https://inventory-billing-app-backend-roes.onrender.com/api/products/getproducts/${currentUser._id}`,
          {
            headers: {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      const t = localStorage.getItem("access_token");
      const res = await fetch(`https://inventory-billing-app-backend-roes.onrender.com/api/products/addproduct/${currentUser._id}`, {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (id) => {
    try {
      const res = await fetch(`https://inventory-billing-app-backend-roes.onrender.com/api/products/deleteproduct/${id}`, {
        method: "DELETE",
      });
      const data = await res.json();
