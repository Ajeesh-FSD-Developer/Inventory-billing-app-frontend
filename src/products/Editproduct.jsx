...
export default function EditProduct() {
  ...
  useEffect(() => {
    const fetching = async () => {
      ...
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/products/editproduct/${params.id}`,
        {
          headers: {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      const t = localStorage.getItem("access_token");
      const res = await fetch(
        `https://inventory-billing-app-backend-roes.onrender.com/api/products/editproductdone/${params.id}`,
        {
          method: "POST",
          headers: {
